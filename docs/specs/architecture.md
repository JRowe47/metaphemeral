...
Related specs: [runtime](runtime.md), [l1 schema](l1-schema.md), [tick trace](tick-trace.md), [activation store](activation-store.md), [training bootstrap](training-bootstrap.md), [research synthesis](research-synthesis.md), [open questions](open-questions.md), [glossary](glossary.md), [bibliography](bibliography.md).
